      ...
      <main className="flex-1 container py-8">
        <div className="mx-auto max-w-sm space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <h2 className="text-2xl font-bold">Join Nexus</h2>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              ...
              <label htmlFor="terms" className="text-sm text-muted-foreground">
                I agree to the{' '}
                <Link to="/nexus/terms" className="text-primary hover:underline">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link to="/nexus/privacy" className="text-primary hover:underline">
                  Privacy Policy
                </Link>
              </label>
            </div>
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link to="/nexus/login" className="font-medium text-primary hover:underline">
              Sign in
            </Link>
          </p>
        </div>
